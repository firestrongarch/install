...
**图表来源**
- [install.py:6-330](file://install.py#L6-L330)
- [packages.yaml:1-72](file://packages.yaml#L1-L72)
...
**章节来源**
- [install.py:141-165](file://install.py#L141-L165)
- [packages.yaml:58-65](file://packages.yaml#L58-L65)
...
**章节来源**
- [install.py:166-228](file://install.py#L166-L228)
- [packages.yaml:66-71](file://packages.yaml#L66-L71)
...
ClashVergeRev:
  type: git
  name: Clash.Verge_2.4.7_amd64.deb
  des: A proxy tool.
